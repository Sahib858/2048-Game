...
public class Board {
   ...
   /*
    * Name: Board (the constructor) Purpose: Constructs a fresh board with random
    * tiles Parameter:int boardSize:set the size of the grid; Random random:a
    * random(number) generator Return: void b/c it's a constructor
    */
   ...
   /*
    * Name: Board (the constructor) Purpose: Construct a board based off of an
    * input file Parameter:String inputBoard:the input file to load a previously
    * saved game; and Random random:a random(number) generator Return: void b/c
    * it's a constructor
    */
   ...
   /*
    * Name: saveBoard Purpose: Saves the current board to a file Parameter:String
    * outputBoard:the output file to save the game Return: void
    */
   ...
   /*
    * Name: addRandomTile Purpose: Adds a random tile (of value 2 or 4) to a random
    * empty space on the board Parameter: None Return: void
    */
   ...
   /*
    * Name: rotate Purpose: Rotates the board by 90 degrees clockwise or 90 degrees
    * counter-clockwise. If rotateClockwise == true, rotates the board clockwise ,
    * else rotates the board counter-clockwise Parameter: boolean
    * rotateClockwise:to determine whether the rotation is clockwise or
    * counter-clockwise Return: void
    */
   ...
   private void moveRight() { // use count to move the tiles to the right one by one
      for (int row = 0; row < GRID_SIZE; row++) {
         int count = 0;
   ...
   private void moveUp() { // use count to move the tiles to the top one by one
      for (int col = 0; col < GRID_SIZE; col++) {
         int count = 0;
   ...
   private boolean canMoveLeft() {
      ...
      // can also move to the left
      {
         for (int col = 0; col < GRID_SIZE - 1; col++) {
            ...
            if (this.grid[row][col] != 0 && this.grid[row][col] == this.grid[row][col + 1]) {
               return true;
            }
         }
   ...
   private boolean canMoveUp() {
...

      {
         for (int row = 0; row < GRID_SIZE - 1; row++) {
            ...
            if (this.grid[row][col] != 0 && this.grid[row][col] == this.grid[row + 1][col]) {
               return true;
            }
         }
