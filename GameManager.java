 ...
 *  Source of help: Piazza, Lecture Notes, Java Documentation
 *  This file helps manage the Game 2048.
 */
...
public class GameManager {
   ...
   /*
    * Name: GameManager(the constructor) Purpose: GameManager Constructor It
    * generates a new game
    * 
    * Parameters: int boardSize:specify the size of the grid String
    * outputBoard:specify where to save the game Random random: a random generator
    * Return: void
    *
    */
   ...
   /*
    * Name: GameManager(the constructor) Purpose: GameManager Constructor It loads
    * a saved game
    * 
    * Parameters: String inputBoard:specify where to load the previously saved game
    * from String outputBoard:specify where to save the game Random random: a
    * random generator Return: void
    *
    */
    ...
    * specify moves to execute // valid moves are: // k - Move up // j - Move Down
    * // h - Move Left // l - Move Right // q - Quit and Save Board // // If an
    * invalid command is received then print the controls // to remind the user of
    * the valid moves. // // Once the player decides to quit or the game is over,
    * // save the game board to a file based on the outputFileName // string that
    * was set in the constructor and then return // // If the game is over print
    * "Game Over!" to the terminal Parameters: none Return: void
    *
    */
   ...
   public void play() throws IOException {
      ...
      while (board.isGameOver() == false) {
         ...
         while ((!userIn.equals("k")) && (!userIn.equals("j")) && (!userIn.equals("h")) && (!userIn.equals("l"))
               && (!userIn.equals("q"))) {
            this.printControls();
         ...
         if (userIn.equals("q")) { // save the board to the outputBoard and quit the game
         ...
         while (this.board.canMove(dir) == false) { // if the board cannot move,print the controls and
   ...
   /*
    * Name: printControls Purpose: Print the Controls keys for the Game
    * 
