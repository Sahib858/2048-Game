 ...
 *  Date:4/8/17
 *  File: Gui2048.java
 *  Source of help: Tutors, Lectures Piazza
...
public class Gui2048 extends Application {
   ...
   /*
    * Name: createTiles Purpose:helper method to intialize the tiles array
    * Parameter:int xTiles, int yTiles Return: Rectangle[][]
    */
   ...
   /*
    * Name: createTexts Purpose:helper method to intialize the texts array
    * Parameter:int xTexts, int yTexts Return: Text[][]
    */
   ...
   /*
    * Name: start Purpose:the vital method to start the game and set up the GUI
    * Parameter:Stage primaryStage Return: void
    */
   ...
   public void start(Stage primaryStage) {
      ...
      header.setText("2048");
      header.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.ITALIC, 50));
      ...
      texts[board.GRID_SIZE - 1][0].setFont(Font.font("Time New Roman", FontWeight.BOLD, 20));
      ...
      for (int x = 0; x < board.GRID_SIZE; x++) {
         for (int y = 1; y < board.GRID_SIZE + 1; y++) {
            ...
            if (board.getGrid()[y - 1][x] < 128) {
               texts[x][y].setFont((Font.font("Time New Roman", FontWeight.BOLD, TEXT_SIZE_LOW)));
            }
            if (board.getGrid()[y - 1][x] < 1024) {
               texts[x][y].setFont((Font.font("Time New Roman", FontWeight.BOLD, TEXT_SIZE_MID)));
            }

            else {
               texts[x][y].setFont((Font.font("Time New Roman", FontWeight.BOLD, TEXT_SIZE_HIGH)));
            }
   ...
   /*
    * Name: updateGUI Purpose: the helper method to update the GUI once a move is
    * performed Parameter: none Return: void
    */
   ...
   /*
    * Name: gameOverCheck Purpose: the helper method to check if the game is over
    * after a valid move; if so, it will stop the game and print the "Game Over!"
    * message Parameter: none Return: void
    */

   private void gameOverCheck() {
      if (board.isGameOver()) {

         Rectangle endCover = new Rectangle(scene.getWidth(), scene.getHeight());
         ...
         endLine.setFont((Font.font("Time New Roman", FontWeight.BOLD, 60)));
   ...
   /*
    * Name: myKeyHandker class Purpose: this inner class implements the
    * eventhandler interface and link the key input to the game
    * 
   ...
   private class myKeyHandler implements EventHandler<KeyEvent> {
      ...
      /*
       * Name: handle Purpose: it detects the key input and perform the corresponding
       * move Parameter: KeyEvent input Return: void
       */
   ...
   private void processArgs(String[] args) {
      ...
      try {
         ...
         System.out.println(e.getClass().getName() + " was thrown while creating a " + "Board from file " + inputBoard);
